...
-- Started on 2025-03-14 22:18:52
...
--
-- TOC entry 4748 (class 2604 OID 16444)
...
--
-- TOC entry 4747 (class 2604 OID 16437)
...
--
-- TOC entry 4902 (class 0 OID 16441)
-- Dependencies: 220
-- Data for Name: assignments; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.assignments (assignment_id, title, description, due_date, student_id) FROM stdin;
1	LAB7 POSTGRES	SET UP A DATABASE AND INSERT RECORDS AS DESCRIBED IN THE INSTRUCTIONS.	2025-03-14	1
\.


--
-- TOC entry 4900 (class 0 OID 16434)
-- Dependencies: 218
-- Data for Name: students; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.students (student_id, first_name, last_name, email, enrollment_date) FROM stdin;
1	Sabrina	Holene	snholene@my.waketech.edu	\N
\.
...
--
-- TOC entry 4752 (class 2606 OID 16448)
...
--
-- TOC entry 4750 (class 2606 OID 16439)
...
--
-- TOC entry 4753 (class 2606 OID 16449)
...
-- Completed on 2025-03-14 22:18:52
